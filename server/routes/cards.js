...
const {getAllCards, getCardById, createCard, deleteCard, updateCard} = require('../controllers/cardController')
...
router.put('/:id', jwtCheck, upload.single('image'), updateCard)
